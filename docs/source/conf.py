# -*- coding: utf-8 -*-
#
# DIMS Job Descriptions documentation build configuration file.
# Hand crafted by Dave on Sun Jan 11 12:11:34 PST 2015
#
...
htmlhelp_basename = 'DIMSJobDescriptionsdoc'
...
latex_documents = [
  ('index', 'DIMSJobDescriptions.tex', u'DIMS Job Descriptions Documentation',
...
man_pages = [
    ('index', 'dimsjds', u'DIMS Job Descriptions Documentation',
     [u'David Dittrich'], 1)
]
...
texinfo_documents = [
  ('index', 'DIMSJobDescriptions', u'DIMS Job Descriptions Documentation',
   u'David Dittrich', 'DIMSJobDescriptions', 'One line description of project.',
   'Miscellaneous'),
]
